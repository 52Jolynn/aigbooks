...
export const report = {
  ...
  scanRunning: '识别中…',
  scanAgain: '再次识别',
  recognitionStepBarcode: '步骤 1 · 条码识别',
  recognitionStepOcr: '步骤 2 · OCR 文字识别',
  recognitionPending: '待执行',
  recognitionRunning: '正在处理…',
  recognitionMatched: '已识别并填充表单',
  recognitionNoMatchContinue: '未识别到条码，继续文字识别',
  recognitionFailedContinue: '条码识别失败，继续文字识别',
  recognitionNoMatch: '未识别到有效信息',
  recognitionFailed: '识别失败，请手动填写',
  ...
  barcodeRetake: '重新扫码',
  tipUpload: '选择图片后自动执行条码识别和文字 OCR，每一步的结果都会立即填入表单',
  tipBarcode: '对准封底右下角的 ISBN/ISSN 条形码，识别成功立即填表',
  tipCamera: '确认照片后自动执行条码识别和文字 OCR，每一步的结果都会立即填入表单',
  submit: '提交举报',
  submitting: '提交中…',
  uploadHint: '拖放或点击上传',
...
export const about = {
  ...
  intent: {
    heading: '为何设立',
    p1: '2023年以来，以 AI 流水线批量炮制的图书与期刊在电商平台上迅速铺开。它们往往具备几个共同的样貌：内容失实——数据与引用查无实据；无情感——人味淡到近乎空白；乏味且"AI 味"重——套话、口号式抒情、空洞比喻层出不穷；缺乏营养——读完既不拓宽认知、也不留下值得回味的东西；甚至给人"虚无"的读后感，像是翻完一本从未存在过的书。',
  ...
  principles: {
    ...
    items: [
      ...
      '我们保留原始证词，而非替你判断。',
      '我们欢迎复核，而非负责仲裁。',
      '我们关心「内容失实、无情感、乏味、AI 味、缺乏营养、没创见、虚无」这些读者的具体感受。',
    ],
